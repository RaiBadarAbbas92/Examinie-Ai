...
export function DashboardLayout({ children, role }: DashboardLayoutProps) {
  ...
  const studentNavItems = [
    ...
    { name: "Take Quiz", href: "/dashboard/student/take-quiz", icon: "file-text" },
    { name: "Results", href: "/dashboard/student/results", icon: "bar-chart" },
  ...
  const teacherNavItems = [
    ...
    { name: "Create", href: "/dashboard/teacher/create", icon: "file-plus" },
    { name: "Customize", href: "/dashboard/teacher/customize", icon: "settings" },
    { name: "Download", href: "/dashboard/teacher/download", icon: "download" },
    { name: "Saved", href: "/dashboard/teacher/saved", icon: "library" },
    { name: "Performance", href: "/dashboard/teacher/performance", icon: "bar-chart-2" },
          ...
          <header className="sticky top-0 z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
            <div className="h-12 flex items-center gap-4 px-4 sm:px-6">
              <div className="ml-auto flex items-center gap-2">
                {/* You can add dashboard header elements here like notifications, profile menu, etc. */}
              </div>
            </div>
          </header>
